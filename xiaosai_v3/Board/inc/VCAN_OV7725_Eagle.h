...
#define OV7725_EAGLE_DMA_NUM      (OV7725_EAGLE_W/8 )                  //DMA采集次数


extern  uint8   ov7725_eagle_init(uint8 imgaddr[][CAMERA_DMA_NUM]);
extern  void    ov7725_eagle_get_img(void);

extern  void    ov7725_eagle_vsync(void);
extern  void    ov7725_eagle_dma(void);
extern unsigned char (*ov7725_eagle_img_buff)[CAMERA_DMA_NUM];
