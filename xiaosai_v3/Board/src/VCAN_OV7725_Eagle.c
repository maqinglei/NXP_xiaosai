...
//unsigned char  ov7725_eagle_img_buff[CAMERA_H+1][CAMERA_DMA_NUM]={{0}};  
unsigned char (*ov7725_eagle_img_buff)[CAMERA_DMA_NUM];
 ...
 *  @since      v5.0
 */
uint8 ov7725_eagle_init(unsigned char imgaddr[][CAMERA_DMA_NUM])
{
